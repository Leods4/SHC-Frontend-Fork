...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function populateCategorias() {
        ...
        const customWrapper = select.nextElementSibling; // O wrapper do custom select
        ...
        try {
            ...
            // Re-inicializa APENAS as opções novas. 
            // Graças à correção no utils.js, isso não vai quebrar o botão de abrir/fechar.
            ...
            setupCustomSelect(customWrapper); // Garante que o erro seja clicável para fechar o menu se necessário
        }
    }
