...
document.addEventListener('DOMContentLoaded', () => {
    ...
    courseForm.addEventListener('submit', async (e) => {
        ...
        const nome = document.getElementById('course-name').value;
        const horas = document.getElementById('course-hours').value;
    ...
    categoryForm.addEventListener('submit', async (e) => {
        ...
        const isEdit = !!id;
        const method = isEdit ? 'PUT' : 'POST'; // Assume PUT existe para categorias
    ...
    saveIntegrationsBtn.addEventListener('click', async () => {
        ...
        try {
            const configData = {
                ...
                horas_minimas: 200, // Defaults para garantir integridade se o backend exigir
                min_por_area: 20,
                max_por_area: 60,
