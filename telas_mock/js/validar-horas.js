...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function showDetailView(studentId, studentName) {
        ...
        try {
            // Rota correta: buscar certificados pelo aluno_id
    ...
    // =======================================================
    // ETAPA 3: LÓGICA DE AVALIAÇÃO (ENVIO PARA API)
    // =======================================================
